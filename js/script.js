...
//Continue for mass calculating {"04/08/25-Cash":4550}    
    "01922362569":{
        ...
        payment             :{"07/03/26-Cash":2050,"14/03/26-Cash":1300,"16/03/26-Cash":500},
        // running month
        stay_cost       :2000,
        garage_cost     :0,
        running_payable :3060,
        running_paid    :3850,
        running_meal    :17,
        // method 
        preMonth,
    ...
    "01797816501":{
        ...
        payment             :{"03/03/26-Cash":2000,"09/03/26-Cash":2000},
        // running month{"04/08/25-Cash":4550}
        stay_cost       :2300,
        garage_cost     :0,
        running_payable :2917,
        running_paid    :4000,
        running_meal    :23,
        // method calling
        preMonth,
    ...
    "01581515641":{//01644377150
        ...
        payment             :{"07/03/26-Cash":3000},
        // running month
        stay_cost       :2800,
        garage_cost     :0,
        running_payable :6420,
        running_paid    :3000,
        running_meal    :26,
        // method calling
        preMonth,
    ...
    "01537664564":{
        ...
        payment             :{"04/03/26-Cash":1000,"11/03/26-Cash":1000,"14/03/26-Cash":3000},
        // running month
        stay_cost       :3000,
        garage_cost     :0,
        running_payable :3649,
        running_paid    :5000,
        running_meal    :15,
        // method calling
        preMonth,
    ...
    "01909752631":{
        ...
        payment             :{"01/03/26-Cash":1000,"04/03/26-Cash":3000},
        // running month
        stay_cost       :2800,
        garage_cost     :0,
        running_payable :4242,
        running_paid    :4000,
        running_meal    :12,
        // method calling
        preMonth,
    ...
    "01934147404":{
        ...
        previous_paid       :6310,
        previous_dining_cost:1829,
        payment             :{"03/03/26-Cash":4500,"11/03/26-Cash":500},
        // running month
        stay_cost       :3500,
        garage_cost     :0,
        running_payable :3574,
        running_paid    :5000,
        running_meal    :19,
        // method calling
        preMonth,
	...
	"01639523533":{
        ...
        payment             :{"02/03/26-Cash":2000,"06/03/26-Cash":1500},
        // running month {"01/07/24-Cash":500}
        stay_cost       :3500,
        garage_cost     :0,
        running_payable :3947,
        running_paid    :3500,
        running_meal    :12,
        // method calling
        preMonth,
    ...
    "01521706612":{
        ...
        payment             :{"06/03/26-Cash":680,"11/03/26-Cash":3000},
        // running month
        stay_cost       :2400,
        garage_cost     :0,
        running_payable :3942,
        running_paid    :3680,
        running_meal    :20,
        // method calling
        preMonth,
	...
	"01821245430":{
        ...
        previous_paid       :2500,
        previous_dining_cost:1829,
        payment             :{"09/03/26-Cash":1500,"11/03/26-Cash":500},
        // running month
        stay_cost       :0,
        garage_cost     :0,
        running_payable :0,
        ...
        if( memberNumber    === "01639523533" 
         ...
         ||memberNumber     ==="01521706612"    || memberNumber === "01821245430"||
            ...
            memberDiningList.innerHTML = `
                                           ...
                                           <tr>
                                                <td>${members["01880384113"].name}</td>
                                                <td>${members["01880384113"].runningDiningCost()}</td>
                                                <td>${members["01880384113"].runningMonth().diningAdd}</td>
                                                <td class="getMeals">${members["01880384113"].runningMonth().remainDining}</td>
                                                <td>${members["01880384113"].runningMonth().diningDue}</td>
                                            </tr>
                                           <tr>
            ...
            if(memberNumber === '01710430501'){
                ...
                costTotalCheck.innerHTML = `<tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="payable">${members["01880384113"].totalPayable()}</td>
                                                <td class="paid-me">${members["01880384113"].running_paid}</td>
                                                <td class="dining-me">${members["01880384113"].runningDiningCost()}</td>
                                                <td class="due-me">${members["01880384113"].runningMonth().diningDue}</td>
                                            </tr>
                                            `;
